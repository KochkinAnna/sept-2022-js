...
for (const coursesArrayElement of coursesArray) {
    ...
    arrDiv.innerHTML =
        `<div class="title"> Title: ${coursesArrayElement.title} </div> 
         <div > <div>MonthDuration: ${coursesArrayElement.monthDuration}</div> <div>HourDuration: ${coursesArrayElement.hourDuration} </div></div> `;
    ...
    document.body.append(arrDiv, modulDiv);
}
